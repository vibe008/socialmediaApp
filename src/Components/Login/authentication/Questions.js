...
const opstyle = { backgroundColor: "white", width: 300, display: "flex", flexDirection: "row", margin: 10, padding: 15, borderRadius: 5, shadowColor: "#000",
                  shadowOffset: {
                    width: 0,
                    height: 2,
                  },
...
const selectopstyle = { backgroundColor: "black", width: 300, display: "flex", flexDirection: "row", margin: 10, padding: 15, borderRadius: 5, shadowColor: "#000",
                  shadowOffset: {
                    width: 0,
                    height: 2,
                  },
